...
public class Analysis {
	...
	public static void main(String[] args) throws IOException
	{
		...
		do
		{
			...
			for(int j = 0; j < lastCentroids.size(); j++) {
				change += Tweets.calcJacardDistance(lastCentroids.get(j),currentCentroids.get(j));
        	}
		}while(change>0);
	...
	public static void readFile(String path) throws IOException
	{
	     ...
	     for (String item : s) 
	     {
	         ...
	         t.setId(Long.parseLong(m[1].substring(1, m[1].indexOf(',')).replace("\"", "")));
	         tweets.add(t);
	     }
	...
	// create clusters
	public static void createclusters(ArrayList<Long> centroids) throws IOException
	{
	...
	// Read initial centroids
	public static ArrayList<Long> readInitialSeeds(String path) throws IOException
	{
